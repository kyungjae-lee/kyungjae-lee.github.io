...
/* 
 * File Name    : heap.h
 * Description  : Header for the Heap Abstract Datatype
...
/* 
 * File Name    : heap.c
 * Description  : Implementation of the Heap Abstract Datatype
 * Reference    : Loudon, K. (1999). Mastering Algorithms with C. O'Reilly
 *                Media, Inc.
 */
...
int heap_extract(Heap *heap, void **data)
{
    ...
    *data = heap->tree[0];
    ...
    /* Heapify the tree by pushing the contetns of the new top downward. */
    ipos = 0;
    lpos = heap_left(ipos);
