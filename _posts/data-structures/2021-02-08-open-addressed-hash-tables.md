---
layout: notes
title: "[Data Structures] Open-Addressed Hash Tables"
meta: Implementation of Open-Addressed Hash Tables
...
/* 
 * File Name    : ohtbl.c
 * Description  : Implementation of the Open-Addressed Hash Table Abstract Datatype
 * Reference    : Loudon, K. (1999). Mastering Algorithms with C. O'Reilly
 *                Media, Inc.
 */
